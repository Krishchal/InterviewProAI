...
// const Backend = () => {
//   const [selectedExpertise, setSelectedExpertise] = useState(["backend"]); // Contains "frontend" by default
...
//       <h1 className="header-text">Backend</h1>
...
const Backend = () => {
	...
	return <ExpertiseSelector topics={topics} title="Backend" apiUrl="http://localhost:5001/recommend-questions" redirectPath="/dashboard/questions" />;
};
